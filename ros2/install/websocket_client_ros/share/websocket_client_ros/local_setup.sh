...
: ${AMENT_CURRENT_PREFIX:="/mine/Code/ROS/ws_test/ros2/install/websocket_client_ros"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/websocket_client_ros/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/websocket_client_ros/environment/path.sh"
